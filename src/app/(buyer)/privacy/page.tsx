    ...
    return (
        <>
            ...
            <div className="flex flex-col container mx-auto items-center justify-center  p-4">
                <h1 className="text-6xl md:text-5xl font-semibold text-[#059669] mb-6 text-center"> Privacy Policy </h1>
                <div className="lg:text-start text-wrap text-gray-700 leading-relaxed">
                    <p className="mb-4 lg:text-2xl text-xl text-[#4B5563]  font-normal">
