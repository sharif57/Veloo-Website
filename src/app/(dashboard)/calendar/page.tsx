              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="flex-1  text-emerald-700 font-semibold py-6 bg-emerald-100 hover:text-white hover:bg-emerald-600 transition-colors"
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className="flex-1 text-white font-semibold py-6 bg-emerald-600 hover:bg-emerald-700 transition-colors"
