...
//   function handleModalOpen(event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
//     event.stopPropagation();
//     // You would typically open a modal here, but since setOpenModal is not passed as a prop,
//     // this is a placeholder. You can lift state up and pass setOpenModal as a prop if needed.
//     // For now, just log for demonstration.
//     console.log(`Open modal for task ${task.id}`);
//   }
...
//             <Calendar className=" text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Categorize:</span>
//             <span className="text-lg font-normal text-muted-foreground">{task.category}</span>
//           </div>

//           {/* Location */}
//           <div className="flex items-center gap-2">
//             <MapPin className="text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Location:</span>
//             <span className="text-lg font-normal text-muted-foreground">{task.location}</span>
//           </div>

//           {/* Resource */}
//           <div className="flex items-center gap-2">
//             <User className="text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Resource:</span>
//             <span className="text-lg font-normal text-muted-foreground">{task.resource}</span>
//           </div>

//           {/* Materials */}
//           <div className="flex items-center gap-2">
//             <Package className="text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Materials ordered:</span>
...
//           {/* Estimated Time */}
//           <div className="flex items-center gap-2">
//             <Clock className="text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Estimated Time:</span>
//             <span className="text-lg font-normal text-muted-foreground">{task.estimatedTime}</span>
//           </div>

//           {/* Total Price */}
//           <div className="flex items-center gap-2">
//             <DollarSign className="text-[#059669]" />
//             <span className="text-xl font-medium text-[#6B7280]">Total Price:</span>
//             <span className="text-lg font-normal text-muted-foreground">{task.totalPrice}</span>
//           </div>

//           {/* Action Buttons */}
//           <div className="flex gap-6 pt-4">
//             <Button variant="ghost" size="sm" className="flex-1 cursor-pointer gap-2 text-[#047857] font-semibold py-6 bg-[#D1FAE5]  hover:text-white hover:bg-[#047857]"
...
//                 <path d="M2 12.5L6.07574 16.5757C6.31005 16.8101 6.68995 16.8101 6.92426 16.5757L9.5 14" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
//                 <path d="M16.5 7L12.5 11" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
//                 <path d="M7.5 12L12.0757 16.5757C12.3101 16.8101 12.6899 16.8101 12.9243 16.5757L22.5 7" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
//               </svg>
