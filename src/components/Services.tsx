            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-12 '>
                {
                    services.map((service) => (
                        <div key={service.title} title={service.title} className='bg-white flex px-14  flex-col gap-4 justify-center items-center p-6 py-8 rounded-2xl hover:shadow-2xl hover:transform-3d duration-500 cursor-pointer text-center'>
