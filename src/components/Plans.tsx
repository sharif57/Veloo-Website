...
//       <h1 className='text-6xl w-1/2 mx-auto leading-16 font-semibold text-[#4B5563] text-center'>Affordable Plans for Service Providers</h1>
//       <div>
//         <div className='grid lg:grid-cols-3 grid-cols-1 gap-8 mt-12 '>
//           {plans.map((plan) => (
//             <div key={plan.title} className='bg-white p-10 space-y-4 rounded-lg cursor-copy' title={plan.title}>
//               <h1 className=' text-[#374151]'><span className='text-4xl font-semibold'>${plan.price}</span> <span className='text-[16px] font-medium'>/ month</span></h1>
//               <p className='text-xl font-medium text-[#374151]'>{plan.title}</p>
//               <div>
//                 {plan.features.map((feature) => (
//                   <div className='flex items-center   gap-4 '>
//                     <div className='bg-[#D1FAE5] p-2 rounded-full '>
//                       <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
//                         <path d="M11.7725 1.83337L6.06833 9.57421C5.93229 9.7547 5.72944 9.87296 5.50535 9.90242C5.28126 9.93188 5.05473 9.87007 4.87667 9.73087L0.803333 6.47421C0.443888 6.18656 0.385685 5.66199 0.673333 5.30254C0.960982 4.94309 1.48555 4.88489 1.845 5.17254L5.24167 7.89004L10.4308 0.84754C10.601 0.592198 10.8977 0.451025 11.2032 0.480071C11.5086 0.509117 11.7734 0.703681 11.8924 0.986517C12.0114 1.26935 11.9653 1.59469 11.7725 1.83337Z" fill="#059669" />
//                       </svg>
//                     </div>
//                     <p className='text-lg font-medium text-[#374151]'>{feature}</p>
//                   </div>
//                 ))}
//               </div>
...
//                 <Button
//                   title="Choose Plan"
//                   className="bg-[#059669] cursor-pointer text-base w-full sm:text-lg font-medium px-4 py-4 sm:px-6 sm:py-6 rounded-md shadow-2xl hover:bg-[#047857] text-white transition-colors flex items-center justify-center mx-auto lg:mx-0"
//                 >
//                   Choose Plan
//                 </Button>
//               </div>
